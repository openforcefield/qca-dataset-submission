...
collection_name = "OpenFF Gen 2 Torsion Set 5 Bayer"
UPDATE = False
...
if not os.path.exists("bayer_selected_torsions.json"):
    with tarfile.open("bayer_selected_torsions.json.tar.gz") as f:
        f.extractfile("bayer_selected_torsions.json")
selected_torsions = read_selected_torsions("bayer_selected_torsions.json")
