...
INPUT_FILE = "t142_selected_torsions.json"
UPDATE = False
...
selected_torsions = read_selected_torsions(INPUT_FILE)
...
for canonical_torsion_index, torsion_data in tqdm.tqdm(
        selected_torsions.items()):
