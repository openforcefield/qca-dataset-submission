...
opt_ds = client.get_collection("OptimizationDataset", "OpenFF VEHICLe Set 1")
opt_ds.query("default", force=True)

if UPDATE:
    hess_ds = client.get_collection("Dataset", "OpenFF VEHICLe Set 1")
else:
    hess_ds = ptl.collections.Dataset("OpenFF VEHICLe Set 1", client=client)
