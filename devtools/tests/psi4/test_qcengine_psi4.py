"""Used for testing psi4 deployment in QCArchive manager production environments.

So far, tests just taken from QCEngine tests.
...
def test_point_energy():
    input_data = {
        "molecule": qcng.get_molecule("water"),
        "driver": "energy",
        "model": {"method": "b3lyp-d3bj", "basis": "dzvp"},
        "keywords": {},
    }
