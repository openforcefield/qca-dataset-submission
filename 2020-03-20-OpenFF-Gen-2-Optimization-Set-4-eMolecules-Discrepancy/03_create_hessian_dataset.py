...
opt_ds = client.get_collection("OptimizationDataset", "OpenFF Gen 2 Opt Set 4 eMolecules Discrepancy")
opt_ds.query("default", force=True)

if UPDATE:
    hess_ds = client.get_collection("Dataset", "OpenFF Gen 2 Opt Set 4 eMolecules Discrepancy")
else:
    hess_ds = ptl.collections.Dataset("OpenFF Gen 2 Opt Set 4 eMolecules Discrepancy", client=client)
