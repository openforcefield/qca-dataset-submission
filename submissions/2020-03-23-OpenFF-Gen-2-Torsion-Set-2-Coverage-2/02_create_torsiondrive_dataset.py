...
collection_name = "OpenFF Gen 2 Torsion Set 2 Coverage 2"
UPDATE = False
...
if not os.path.exists("coverage_2_selected_torsions.json"):
    with tarfile.open("coverage_2_selected_torsions.json.tar.gz") as f:
        f.extractfile("coverage_2_selected_torsions.json")
selected_torsions = read_selected_torsions("coverage_2_selected_torsions.json")
