# OpenFF NSP Optimization Set 1 P v1.0
...
- Name: OpenFF NSP Optimization Set 1 P v1.0
- Number of unique molecules: 422
- Number of filtered molecules: 0
- Number of conformers: 2819
- Number of conformers per molecule (min, mean, max): 1, 6.68, 10
- Mean molecular weight: 277.86
- Min molecular weight: 90.10
- Max molecular weight: 588.74
- Charges: [-5.0, -4.0, -3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0]
- Dataset Submitter: Pavan Behara
- Dataset Curator: Pavan Behara

## Metadata
- Elements: {Cl, F, P, Br, S, H, I, N, C, O}
- Spec: default
	 - basis: DZVP
...
- `phosphorous_smarts_updated.md`: Set of SMARTS patterns used to query PubChem. 
