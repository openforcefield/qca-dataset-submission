# OpenFF Architector Unconstrained Methyl-Capped Metal Complexes Optimization Dataset v0.0
...
'lowdin_charges', 'dipole_polarizabilities', 'mulliken_charges'. These structures are loosely optimized without constraints.

### General Information

- Date: 2026-08-25
- Purpose: Metal complexes with methyl-capped ligands optimized with BP86/def2-TZVP.
- Dataset Type: optimization
- Name: OpenFF Architector Unconstrained Methyl-Capped Metal Complexes Optimization Dataset v0.0
...
* Spec: BP86/def2-TZVP
    ...
    * qc_specification:
       ...
       * method: bp86
       * basis: def2-tzvp
       * keywords: {'maxiter': 500, 'reference': 'uks', 'scf_properties': ['dipole', 'quadrupole', 'wiberg_lowdin_indices', 'mayer_indices', 'lowdin_charges', 'mulliken_charges'], 'function_kwargs': {'properties': ['dipole_polarizabilities']}, 'properties_origin': ['COM']}
