...
collection_name = "OpenFF Gen 2 Torsion Set 4 eMolecules Discrepancy 2"
UPDATE = False
...
if not os.path.exists("emolecules_2_selected_torsions.json"):
    with tarfile.open("emolecules_2_selected_torsions.json.tar.gz") as f:
        f.extractfile("emolecules_2_selected_torsions.json")
selected_torsions = read_selected_torsions("emolecules_2_selected_torsions.json")
