...
### General Information
 ...
 - Name: OpenFF Gen 2 Opt Set 3 Pfizer Discrepancy
 - Number of Entries: 197 optimizations
 - Number of Molecules: 91
...
1. Run generateOptDS.py with a string containing the OptimizationDataset name.
    ```
    python 01_generateOptDS.py 'Pfizer Discrepancy Optimization Dataset 1'
    ```
2. Submit the .json file that is created in step 1 to QCFractal server.
   ```
   python 02_create_optimization_dataset.py 'OpenFF Gen 2 Opt Set 3 Pfizer Discrepancy'
   ```
