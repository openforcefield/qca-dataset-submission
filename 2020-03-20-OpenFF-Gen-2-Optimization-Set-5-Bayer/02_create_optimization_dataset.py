...
def main(DSName):
    """
    Submits the data set using the dataset Name input into main()
    """
    ...
    ds = ptl.collections.OptimizationDataset(DSName, client=client)
...
if __name__ == '__main__':
    ...
    print('This name of the new optimization data set for submission:', args.strings)
    main(args.strings)
