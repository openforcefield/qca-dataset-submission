...
collection_name = "OpenFF Gen 2 Torsion Set 6 Supplemental"
UPDATE = False
...
if not os.path.exists("supplemental_selected_torsions.json"):
    with tarfile.open("supplemental_selected_torsions.json.tar.gz") as f:
        f.extractfile("supplemental_selected_torsions.json")
selected_torsions = read_selected_torsions("supplemental_selected_torsions.json")
