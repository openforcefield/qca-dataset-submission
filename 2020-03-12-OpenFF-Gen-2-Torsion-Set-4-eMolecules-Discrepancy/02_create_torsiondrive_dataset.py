...
collection_name = "OpenFF Gen 2 Torsion Set 4 eMolecules Discrepancy"
UPDATE = False
...
if not os.path.exists("emolecules_selected_torsions.json"):
    with tarfile.open("emolecules_selected_torsions.json.tar.gz") as f:
        f.extractfile("emolecules_selected_torsions.json")
selected_torsions = read_selected_torsions("emolecules_selected_torsions.json")
