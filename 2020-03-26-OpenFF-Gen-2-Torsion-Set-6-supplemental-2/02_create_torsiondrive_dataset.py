...
if not os.path.exists("supplemental_2_selected_torsions.json"):
    with tarfile.open("supplemental_2_selected_torsions.json.tar.gz") as f:
        f.extractfile("supplemental_2_selected_torsions.json")
selected_torsions = read_selected_torsions("supplemental_2_selected_torsions.json")
