...
if not os.path.exists("bayer_2_selected_torsions.json"):
    with tarfile.open("bayer_2_selected_torsions.json.tar.gz") as f:
        f.extractfile("bayer_2_selected_torsions.json")
selected_torsions = read_selected_torsions("bayer_2_selected_torsions.json")
