...
collection_name = "OpenFF Gen 2 Torsion Set 3 Pfizer Discrepancy"
UPDATE = False
...
if not os.path.exists("pfizer_selected_torsions.json"):
    with tarfile.open("pfizer_selected_torsions.json.tar.gz") as f:
        f.extractfile("pfizer_selected_torsions.json")
selected_torsions = read_selected_torsions("pfizer_selected_torsions.json")
