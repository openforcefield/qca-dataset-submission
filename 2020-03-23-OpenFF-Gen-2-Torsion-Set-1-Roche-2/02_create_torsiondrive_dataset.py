...
collection_name = "OpenFF Gen 2 Torsion Set 1 Roche 2"
UPDATE = False
...
if not os.path.exists("roche_2_selected_torsions.json"):
    with tarfile.open("roche_2_selected_torsions.json.tar.gz") as f:
        f.extractfile("roche_2_selected_torsions.json")
selected_torsions = read_selected_torsions("roche_2_selected_torsions.json")
